...
All commands assume that your location is the folder where VislabController and this readme are.
...
STARTING
Docker compose is configed to work out-of-the-box, but changes are HIGHLY recommended, as username, passwords and databasename are weak and non descriptive.
...
"docker rmi opt1:ver opt2:ver" will remove the given images (replace opt1:ver and opt2:ver with appropriate image names.
